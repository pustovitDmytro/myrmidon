...
test('Positive: isEmpty with empty input @examples', function () {
    // tester.test([], true);
    tester.test({}, true);
});

test('Negative: isEmpty with no-array input @examples', function () {
...
test('Negative: isEmpty with empty input @examples', function () {
